        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <Link to="/" className="flex-shrink-0 flex items-center">
              <span className="text-primary font-bold text-xl">QUADRO-TECH</span>
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Link to="/services" className="px-3 py-2 text-sm font-medium text-gray-700 hover:text-primary">
              Услуги
            </Link>
            <Link to="/contact" className="px-3 py-2 text-sm font-medium text-gray-700 hover:text-primary">
              Контакты
            </Link>
            <Button className="ml-4">Заказать звонок</Button>
          </div>
      ...
      {isOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <Button className="w-full mt-3">Заказать звонок</Button>
          </div>
        </div>
      )}
    </nav>
